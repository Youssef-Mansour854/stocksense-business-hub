...
import { 
  ...
  Archive, TrendingUp, Users as UsersIcon
} from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">إدارة بيانات العملاء والحسابات</p>
        </div>
        ...
        <Card className="p-4">
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{stats.totalBalance.toLocaleString()} ر.س</p>
            </div>
          </div>
        </Card>
        <Card className="p-4">
